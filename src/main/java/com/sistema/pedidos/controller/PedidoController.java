...
public class PedidoController {
    ...
    @GetMapping("/cliente")
    @Operation(summary = "Buscar pedidos por cliente", description = "Retorna uma lista de pedidos de um cliente específico")
    ...
    @GetMapping("/periodo")
    @Operation(summary = "Buscar pedidos por período", description = "Retorna uma lista de pedidos realizados dentro de um período específico")
    ...
    @Operation(summary = "Buscar pedidos por status", description = "Retorna uma lista de pedidos com um status específico")
    ...
    @PostMapping
    @Operation(summary = "Criar um novo pedido", description = "Cria um novo pedido com os dados informados")
